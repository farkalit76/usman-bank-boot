...
public class SecurityRSDTO implements Serializable {
	...
	private Boolean validRequestCredentials ;
	private String permanentDeviceId;

	public Boolean getValidRequestCredentials() {
		return validRequestCredentials;
	}
	public void setValidRequestCredentials(Boolean validRequestCredentials) {
		this.validRequestCredentials = validRequestCredentials;
	}
	
	
	public Boolean getIsValidRequestCredentials() {
		return isValidRequestCredentials;
	}
	public void setIsValidRequestCredentials(Boolean isValidRequestCredentials) {
		this.isValidRequestCredentials = isValidRequestCredentials;
	}


	private String secureToken;   
	private String nonce ; //Android nonce
