...
import com.usman.bank.account.utils.AccountHelper;
...
public class AccountSoapServiceImpl implements AccountSoapService {
	...
	@Override
	@Cacheable(value = "accountCache", key = "#accountReq.cifNumber")
	public List<AccountDTO> getAccountsDetails(AccountDetailReq accountReq) throws AccountsException {
		LOG.debug("AccountDetailServiceImpl.getAccountsDetails started...");
		return getAccountsByCif(accountReq.getCifNumber());
	}
	 ...
	 * @return
	 */
	private List<AccountDTO> getAccountsByCif(String cifNumber) {
	 ...
	 * @return
	 */
	private RequestDTO getRequestDTO(String cifNumber) {
		RequestDTO requestDTO = new RequestDTO();
		HashMap<Integer, Object> requestDetailsMap = new HashMap<>();
		requestDetailsMap.put(LogTransFields.CIF_NUMBER, cifNumber);
