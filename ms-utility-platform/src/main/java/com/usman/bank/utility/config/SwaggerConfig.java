 ...
 */
package com.usman.bank.utility.config;
...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.usman.bank.utility.web.resource"))
	...
	private ApiInfo getApiInformation() {
		...
		return new ApiInfo("usman Utility Services API Documentation", "usman bank API Documentation", "1.0",
