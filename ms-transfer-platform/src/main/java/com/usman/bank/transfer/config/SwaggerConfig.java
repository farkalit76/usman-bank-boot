...
public class SwaggerConfig {
	...
	@Bean
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select().apis(RequestHandlerSelectors.basePackage("com.usman.bank.transfer.web.resource"))
	...
	private ApiInfo getApiInformation() {
		...
		return new ApiInfo("usman Transfer Management API Documentation", "usman bank API Documentation", "1.0",
